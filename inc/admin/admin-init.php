<?php
/**
* The Builderrin_Admin initiate the theme admin
*/
...
class Builderrin_Admin extends Builderrin_Base{
    ...
    public function fix_parent_menu() {
		...
		$submenu['pxlart'][0][0] = builderrin()->get_name().' '.esc_html__( 'Dashboard', 'builderrin' );
