...
if (!class_exists('Builderrin_Main')) {
    class Builderrin_Main extends Builderrin_Base
    {
        ...
        function __construct(){
            ...
            $this->header = new Builderrin_Header();

            // Footer
            require get_template_directory() . '/inc/classes/class-footer.php';
            $this->footer = new Builderrin_Footer();

            // Page
            require get_template_directory() . '/inc/classes/class-page.php';
            $this->page = new Builderrin_Page();

            // Blog
            require get_template_directory() . '/inc/classes/class-blog.php';
            $this->blog = new Builderrin_Blog();

            // Shop
            require get_template_directory() . '/inc/classes/class-shop.php';
            $this->shop = new Builderrin_Shop();
        ...
        public static function getInstance()
        {
            ...
            if (null === self::$instance) {
                self::$instance = new Builderrin_Main();
            }
...
function builderrin() {
    return Builderrin_Main::getInstance();
}
// Install
builderrin();

builderrin_action( 'init' );