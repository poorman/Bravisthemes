...
$widget->add_render_attribute( 'pxl_img_wrap', 'class', 'pxl-image-wg', ['pxl-image-wg', 'layout-'.$settings['layout']]);
...
<div <?php pxl_print_html($widget->get_render_attribute_string( 'pxl_img_wrap')); ?> data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
    <?php if ( $link ) : ?>
        ...
        <?php else: ?>
            ...
            <?php if(!empty($settings['experience_title']) && !empty($settings['experience_subtitle'] )) :?>
                <div class="experience">
                    <span class="title"><?php echo pxl_print_html($settings['experience_title']); ?></span>
                    <span class="subtitle"><?php echo pxl_print_html($settings['experience_subtitle']); ?></span>
                </div>
            <?php endif; ?>
        <?php endif; ?>
        <?php if ( $link ) : ?>
