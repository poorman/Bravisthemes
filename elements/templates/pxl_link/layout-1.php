...
if(isset($settings['link']) && !empty($settings['link']) && count($settings['link'])): ?>
    <ul class="pxl-link pxl-link-l1 <?php echo esc_attr( $settings['style'] ); ?> <?php echo esc_attr( $settings['display_style'].' '.$settings['pxl_animate'] ); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
        <?php
