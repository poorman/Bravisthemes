...
class Builderrin_Recent_Services_Widget extends WP_Widget
{
    function __construct()
    {
        parent::__construct(
            'pxl_recent_services',
            esc_html__( '* Pxl Recent Services', 'builderrin' ),
            array(
                'description' => esc_html__( 'Your site’s most recent Services.', 'builderrin' ),
...
add_action( 'widgets_init', 'builderrin_register_recent_widget1' );
function builderrin_register_recent_widget1(){
    if(function_exists('pxl_register_wp_widget')){
        pxl_register_wp_widget( 'Builderrin_Recent_Services_Widget' );
    }
}